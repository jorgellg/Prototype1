...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        memen = new Memen();
        tiroArco = new TiroArco();
        lienzo = new Lienzo(this, tiroArco);
        ...
        btnDeshacer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(actual>0)
                    --actual;
                tiroArco.restaurarMemento(memen.getMemento(actual));
                lienzo.setTiroArco(tiroArco);
                lienzo.invalidate();
            }
        });
    ...
    public void setMemento(int color) {
        tiroArco.setColor(color);
        lienzo.setTiroArco(tiroArco);
        lienzo.invalidate();
        memen.addMemento(tiroArco.guardarMemento());
        ultimo = memen.getMementos().size()-1;
        actual = ultimo;
